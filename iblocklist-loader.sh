...
# ------List name-(Organizations)-Maintainer--Download URL-------------------------------------------------------------------------
...
List47="SonyOnlineEntertainment   I-Blocklist http://list.iblocklist.com/?list=tukpvrvlubsputmkmiwg&fileformat=p2p&archiveformat=gz"
List48="CrowdControlProductions   I-Blocklist http://list.iblocklist.com/?list=eveiyhgmusglurfmjyag&fileformat=p2p&archiveformat=gz"
